 ...
 */
public class SlideThreeLargeImage extends PresentationSlides{

    private String TAG = "SlideThreeLargeImageTAG";

    // Text Variables (Header)
    public TextHandler textHandler;
    TextView slide3TextHeading;
    String headingText = "Slide/Image Heading";
    int headingSize = 25;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slide_three_large_image);

        embedImage();

        slide3TextHeading = (TextView)findViewById(R.id.slide_3_heading);

        addText(slide3TextHeading);
    }
    ...
    public void embedImage(){
        imageView = (ImageView)findViewById(R.id.slide_3_image);

        String imageToEmbed = "ic_football";
        String frameToEmbedImage = "slide_3_image";
